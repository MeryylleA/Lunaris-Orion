...
client.stripe = stripe; // Disponibiliza o cliente Stripe para os comandos
...
client.on('interactionCreate', async interaction => {
    ...
    try {
        ...
        logger.debug('Resposta inicial enviada');
...
// Login do bot
logger.info('Iniciando login do bot...');
client.login(process.env.DISCORD_TOKEN)
    .then(() => logger.info('Login realizado com sucesso!'))
    .catch(error => {
